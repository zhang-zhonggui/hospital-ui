<template>
  <div id="index">
    <el-container>
      <el-header>
        <div class="header-content">
          <router-link to="/" class="logo">
            <i class="el-icon-office-building"></i> 好医生
          </router-link>
          <span class="slogan">好医生帮你找到好医生</span>
          <div class="nav">
            <el-link type="primary"
              ><router-link to="staff/login">员工登录</router-link></el-link
            >
            <el-link type="success" to="login">患者登录</el-link>
          </div>
        </div>
      </el-header>
      <!-- <el-header>
      ...
      <el-dialog title="表单弹框" :visible="dialogVisible" width="50%">
        <el-table :visible="dialogVisible" :data="userData" style="width: 100%">
      ...
      <el-footer>
        ...
        <i cite="el-icon-location-information"
          >郑州市金水区杨金路牛顿国际6楼 | 豫ICP备123789456号</i
        >
      </el-footer>
    </el-container>
  </div>
